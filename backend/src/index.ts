...
import insumosAdminRoutes from './routes/insumos-admin';
...
import adminTecnicosRoutes from './routes/admin-tecnicos';
...
app.use('/api/admin/tecnicos', adminTecnicosRoutes);
app.use('/api/admin/insumos', insumosAdminRoutes);
