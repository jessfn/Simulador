      ...
      {!mostrarForm && (
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-100 p-4">
          <button onClick={enviar} disabled={guardando}
            className="w-full max-w-[700px] mx-auto block bg-[#1A5C38] hover:bg-[#124227] text-white py-3.5 rounded-2xl font-bold text-[14.5px] active:scale-[0.98] transition-all disabled:opacity-50">
